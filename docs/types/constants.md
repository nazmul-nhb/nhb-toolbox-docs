...
| `TIME_ZONE_IDS`          | Record 597 of timezone identifiers (from [**IANA TZ Database on Wikipedia**](https://en.wikipedia.org/wiki/List_of_tz_database_time_zones)) against their corresponding UTC offsets and full timezone names.                       |
