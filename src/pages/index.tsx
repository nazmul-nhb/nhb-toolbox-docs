			...
			<div className="container">
				...
				<div className={styles.heroHighlights}>
					<div className={styles.heroHighlightItem}>
						<strong>190+ Utilities</strong> — for daily development
					</div>
					<div className={styles.heroHighlightItem}>
	...
	return (
		<Fragment>
			<Head>
				...
				<meta
					name="description"
					content="NHB Toolbox: A comprehensive collection of 190+ type-safe utilities and 6 powerful classes for professional TypeScript/JavaScript development. Featuring string/number/color utilities, FormData and date handling, type guards, utility types and minimal DOM operations."
				/>
				<meta
